			...
			<div class="text-inner">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						...
						<h2 class="to-animate">Estan en el lugar indicado</h2>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container" >
		...
		<div class="swiper-container">
			<div class="swiper-wrapper">
			  <div class="swiper-slide" style="background-image:url('images/Trabajos/img(1).jpg')"></div>
			  <div class="swiper-slide" style="background-image:url('images/Trabajos/img (2).jpg')"></div>
			  <div class="swiper-slide" style="background-image:url('images/Trabajos/img (3).jpg')"></div>
			  <div class="swiper-slide" style="background-image:url('images/Trabajos/img (4).jpg')"></div>
			  <div class="swiper-slide" style="background-image:url('images/Trabajos/img (5).jpg')"></div>
			  <div class="swiper-slide" style="background-image:url('images/Trabajos/img (6).jpg')"></div>
			</div>
			<!-- Add Pagination -->
